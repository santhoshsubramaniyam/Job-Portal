...
<div class="main-page">
    ...
    <h3 class="login__header header">Welcome back Recruiter</h3>
    ...
    <a href="javascript:void(0)">Employer</a>&nbsp;/&nbsp;<a href="candidateSignup.jsp">Candidate</a>
    </div>
    <fieldset class="form">
      <!-- <legend class="form__legend">OR</legend> -->
    <form action="employerLogin" class="form__body form-login" method="post">  
      <input type="email" required="required" class="form__input" id="exampleInputEmail1" name="employerEmail" placeholder="email">
      <input type="password" required="required"class="form__input" id="exampleInputPassword1"  name="employerPassword" placeholder="Password">  
    ...
    <div class="switch__text-container"  id="switch-text">
      <h3 class="switch__header header">Not yet a member?</h3>
    ...
    <fieldset class="form">
      <!-- <legend class="form__legend">OR</legend> -->
    <form action="addEmployer" class="form__body form-login" method="post" enctype="multipart/form-data">
      <div class="input__group">
          <input class="form__input form__input-half" type="text" name="companyName" placeholder="Companyname">
          <input class="form__input form__input-half" type="text" name="employerName" placeholder="EmployerName">
      </div>
      <div class="input__group">
         <input class="form__input form__input-half" type="text" name="employerLocation" placeholder="Location">
         <input class="form__input form__input-half" type="text" name="employerPhone" placeholder="+91-">      
      </div>
      <div class="input__group">
         <input class="form__input form__input-half" type="email" name="employerEmail" placeholder="email">
         <input class="form__input form__input-half" type="password" name="employerPassword" placeholder="password">      
      </div>
      
      <div class="input__group">
	      <textarea class="form__input" style="margin:0px 200px 5px -1px; padding:12px 0 0 12px;" name="companyDescription" placeholder="Description"></textarea>
      </div>

      <div class="input__group">
      	  <input type="file" class="form__input" style="margin:13px 76px 5px -1px; padding:12px 0 0 12px;" name="companyLogo">
      </div>

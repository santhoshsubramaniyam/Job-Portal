...
if (rs.next()) {
	  firstName = rs.getString("companyName");
	     lastName = rs.getString("employerName");
	     Phone = rs.getString("employerLocation");
	     Pass = rs.getString("employerPhone");
	     about = rs.getString("companyDescription");
	     pwd = rs.getString("employerPassword");
        ...
        <div class="col-lg-8 col-xl-9">
          ...
          <div class="dashboard__content contact__form__wrapper">
            <div class="campaigns__wrapper">
              ...
              <form class="create__campaigns__form" action="updateProfileEmployer" method="POST">
                <div class="row">
                  <div class="col-xl-3">
                    <div class="job-poster">
                      <div class="job-poster-header">
                  ...
                  <div class="col-md-12">
                    <div class="form-group ">
                      ...
                      <input type="text" name="comName" class="form-control form--control " value="<%=firstName %>" required id="title">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group ">
                      <label for="title" class="required"> Employer Name</label>
                      <input type="text" name="empName" class="form-control form--control " value="<%=lastName %>" required id="title">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group ">
                      <label for="title" class="required"> Location</label>
                      <input type="text" name="comLoc" class="form-control form--control " value="<%=Phone %>" required id="title">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group ">
                      ...
                      <input type="number" name="comPhone" class="form-control form--control " value="<%=Pass%>" required id="title">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group ">
                      ...
                      <input type="email" name="comEmail" class="form-control form--control " value="<%=email %>" required id="title">
                    </div>
                  </div>
                </div>
					  ...
					  <div class="col-md-12">
					    <div class="form-group">
					      ...
					      <div class="input-group">
					        <input type="password" name="comPass" class="form-control form--control" value="<%=pwd %>" required id="password">
				...
				<div class="row">
                  <div class="col-md-12">
                    <div class="form-group ">
                      <label for="title" class="required"> About Company</label>

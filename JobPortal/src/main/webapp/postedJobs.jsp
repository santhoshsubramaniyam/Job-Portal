  ...
  <div class="banner-inner bg_img" style="background: url(https://emicrotasks.com/assets/templates/basic/images/bg/banner.png);">
    <div class="container">
      <div class="banner__inner__content">
        <h2 class="banner__inner__content-title">Posted Job</h2>
...
stmt.setString(1, email);
	...
	%>
            ...
            <a href="appliedCandidates.jsp?jobId=<%=uniqueKey%>&email=<%=email%>">
            <div class="job__item">
                    <div class="job__item-thumb">
                        <img src="https://www.pngplay.com/wp-content
                        /uploads/9/Job-Transparent-File.png" alt="job">
                    </div>

  ...
  <div class="banner-inner bg_img" style="background: url(https://emicrotasks.com/assets/templates/basic/images/bg/banner.png);">
    <div class="container">
      <div class="banner__inner__content">
        <h2 class="banner__inner__content-title">Manage Job</h2>
...
stmt.setString(1, email);
		...
		while (rs.next()) {
			uniqueKey=rs.getString("uniqueKey");
			  comName = rs.getString("companyName");
			     ...
			     date = rs.getString("appliedData");
			     location = rs.getString("jobLocation");
			     ctc = rs.getString("jobSalary");
	...
	%>
            ...
            <a href="updateJob.jsp?jobId=<%=uniqueKey%>&email=<%=email%>">
    <div class="job__item">
        <div class="job__item-thumb">
            <img src="https://www.pngitem.com/pimgs/m/189-1893531_update-upgrade-renew-improve-improvement-new-update-and.png" alt="job">
        </div>
        <div class="job__item-content">
            <div class="wrapper d-flex justify-content-between align-items-center">
                ...
                <span style="margin-left: 1rem;" class="job-author text--primary tag btn btn--sm">
                   <%=date %>
                </span>
            </div>
            <h5 class="title">
            ...
            <%-- <form method="post" action="deleteJobServlet">
                ...
                <input type="hidden" name="unique" value="<%=uniqueKey%>">
                <button type="submit" class="btn btn--base">Delete</button>
            </form> --%>
        </div>
    </div>
    </a>

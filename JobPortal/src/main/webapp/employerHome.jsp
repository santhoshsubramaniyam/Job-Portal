...
<header class="flex">
    <article>
        ...
        <p>Let's Make your next great Hire.Fast.</p>
        <a href="jobPost.jsp?email=<%=mail%>" class="btn btn_3">Post a Job</a>
    </article>
    <section class="flex" style="margin-bottom: -30px;">
        <aside class="padding_1x" >
            <h3 class="sub_title">Create your free account</h3>
            <p>All you need is your email address to create an account and start building your job post.Then just add a title, description, and location to your job post, and you're ready to go.After you post your job use our state of the art tools to help you find dream talent.</p>
            <a href="#"><i class="fa fa-angle-right"></i></a>
        </aside>
        <aside class="padding_1x">
            <h3 class="sub_title">Build your job post</h3>
            <p>Then just add a title, description, and location to your job post, and you're ready to go.After you post your job use our state of the art tools to help you find dream talent.After you post your job use our state of the art tools to help you find dream talent.</p>
            <a href="#"><i class="fa fa-angle-right"></i></a>
        </aside>
        <aside class="padding_1x">
            <h3 class="sub_title">Post your job</h3>
            <p>After you post your job use our state of the art tools to help you find dream talent.All you need is your email address to create an account and start building your job post.Then just add a title, description, and location to your job post, and you're ready to go.</p>
            <a href="#"><i class="fa fa-angle-right"></i></a>
        </aside>
    </section>
</header>
...
<main>
    ...
    <div class="row" >
        ...
        <div class="col-lg-6 p-1" style="margin-left: 26rem;">
                ...
                <div class="container">
                    <div class="overview__content ps-lg-4 ps-xxl-5 padding-top padding-bottom">
                        <div class="section__header mb-0">
                            <h2 class="section__header-title">I Want To Hire Candidate </h2>
                            <p style="color: black;">Find your jobs by Searching related your job title. Or browse job by Category as per your need and profession and creat a Job</p>
                            <a href="jobPost.jsp?email=<%=mail%>" class="btn">Post A Job</a>
                        </div>
                    </div>
                </div>
                <img src="https://emicrotasks.com/assets/images/frontend/overview/638f07058bec91670317829.png" alt="overview" class="shape1">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-3 g-xl-4 justify-content-center">
                    ...
                    <div class="category__item">
                        ...
                        <div class="category__item-content">
                            ...
                            <p class="mt-2" style="color: black;">Login/Signup to view</p>
                        </div>
                        
                        <a class="job_cate" href="#"></a>
                    </div>
                </div>
                            <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="category__item">
       ...
       <div class="sptb "> 
			<div class="container">
        		<div class="get-started d-flex flex-wrap align-items-center justify-content-between">
            		...
            		<a href="jobPost.jsp?email=<%=mail%>" class="cmn--btn">Start posting</a>
        		</div>
    		</div>
    		</div>
    		</section>

             ...
             <div class="main-container">
              ...
              <div class="searched-jobs">
               <div class="searched-bar">
                <div class="searched-show">Showing All Jobs</div>
...
<%
		...
		String query = "SELECT * FROM joblist WHERE status = 'open'";
		...
		while (rs.next()) {
			...
			String jobDes = rs.getString("jobDes");
			String jobType = rs.getString("jobType");
			String jobExp = rs.getString("jobExperience");
			String photo = rs.getString("companyLogo");
	...
	%>
                <div class="job-card">
                 <div class="job-card-header">
					<img style="width: 4rem; height: 4rem; border-radius: 3rem;" alt="jobImaage" src="<%=photo%>">
                  <div class="menu-dot"></div>
                 </div>
                 <div class="job-card-title"><%=jobName %></div>
                 <div style="text-align: justify;" class="job-card-subtitle">
                 <%=jobDes %>
                 </div>
                 <div class="job-detail-buttons">
                  <button class="search-buttons detail-button"><%=jobType %></button>
                  <button class="search-buttons detail-button"><%=jobExp%></button>
                 </div>
                 <div class="job-card-buttons">
                  <a  href="jobDetail.jsp?id=<%=id%>&email=<%=mail%>"><button style="margin: 14px 51px 0 0;" class="search-buttons card-buttons">Apply Now</button></a>
